...
.defines(function(){
        MyGame = ig.Game.extend({
            ...
            init: function() {
                ...
                this.loadLevel( LevelEverything_test );
            ...
            draw: function() {
                ...
                if(this.instructText){
                    ...
                    this.instructText.draw('Left/Right Moves, X Jumps. C Fires and Tab switches weapons.', x, y, ig.Font.ALIGN.CENTER);
                }
                if(this.showStats){
...
// up by a factor of 2
ig.main( '#canvas', MyGame, 60, 320, 120, 4 );
